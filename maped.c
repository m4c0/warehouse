  ...
  switch (msg) {
    ...
    case WM_KEYDOWN:
      ...
      switch (LOWORD(w_param)) {
        case VK_LEFT:  mpd_cursor(-1,  0);    break;
        case VK_RIGHT: mpd_cursor( 1,  0);    break;
        case VK_UP:    mpd_cursor( 0, -1);    break;
        case VK_DOWN:  mpd_cursor( 0,  1);    break;
        case VK_SPACE: mpd_empty();           break;
        case VK_OEM_4: mpd_load_prev_level(); break;
        case VK_OEM_6: mpd_load_next_level(); break;

        case 'B': mpd_box();    break;
        case 'P': mpd_player(); break;
        case 'T': mpd_target(); break;
        case 'W': mpd_wall();   break;
      }
